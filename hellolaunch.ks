...
UNTIL SHIP.ALTITUDE = 100000 {
    UNTIL SHIP:APOAPSIS > 100000 {      // Remember, all altitudes will be in meters, not kilometers
        ...
        // Once we pass 100m/s, we want to pitch down ten degrees
            ...
            PRINT "Apoapsis: " + ROUND(SHIP:APOAPSIS,0) + " m" AT (0,16).
            PRINT "Altitude: " + ROUND(SHIP:ALTITUDE,0) + " m" AT (0,17).
            PRINT "Vertical Speed: " + ROUND(SHIP:VERTICALSPEED,0) + " m/s" AT (0,18).
            PRINT "Ground Speed: " + ROUND(SHIP:GROUNDSPEED,0) + " m/s" AT (0,19).
            PRINT "Fthrust: " + ROUND(SHIP:THRUST,0) + " kN" AT (0,20).
            PRINT "Fgravity: " + (ROUND(SHIP:MASS,0) * 1000) * 9.81 + " N" AT (0,21).
...
s
        IF SHIP:GROUNDSPEED >= 12240 AND SHIP:VERTICALSPEED >= 1172 {
        PRINT "Satisfied Orbital Velocity Conditions" AT (0,22).  
        }.
    }.

    PRINT "100 km apoapsis reached, cutting throttle" AT (0, 30).
